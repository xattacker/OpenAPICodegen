...
import org.openapitools.client.models.ServiceDTOVersion2BikeBikeShape

import org.openapitools.client.infrastructure.*

class CyclingApiApi(basePath: kotlin.String = "http://ptx.transportdata.tw/MOTC") : ApiClient(basePath) {
    ...
    * @return kotlin.Array<ServiceDTOVersion2BikeBikeShape>
    */
    @Suppress("UNCHECKED_CAST")
    fun cyclingApiShape(city: kotlin.String, &#x60;$format&#x60;: kotlin.String, &#x60;$select&#x60;: kotlin.String? = null, &#x60;$filter&#x60;: kotlin.String? = null, &#x60;$orderby&#x60;: kotlin.String? = null, &#x60;$top&#x60;: kotlin.String? = null, &#x60;$skip&#x60;: kotlin.String? = null) : kotlin.Array<ServiceDTOVersion2BikeBikeShape> {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/v2/Cycling/Shape/{City}".replace("{"+"City"+"}", "$city"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<kotlin.Array<ServiceDTOVersion2BikeBikeShape>>(
            localVariableConfig,
            localVariableBody
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as kotlin.Array<ServiceDTOVersion2BikeBikeShape>
