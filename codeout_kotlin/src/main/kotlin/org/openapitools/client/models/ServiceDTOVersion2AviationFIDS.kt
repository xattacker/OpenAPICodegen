 ...
 * @param departureRemark 航班屬性狀態,為第三方觀點的狀態(資料來源:民航局)
 * @param departureRemarkEn 航班屬性狀態(英文)
 * @param arrivalRemark 航班屬性狀態,為該機場觀點的狀態
 * @param arrivalRemarkEn 航班屬性狀態(英文)
 * @param flightStatus 航班運行狀態,以航班的角度的狀態
 * @param flightStatusEn 航班運行狀態(英文)
 * @param flightStatusPC 航班運行狀態百分比(國內線)
 * @param flightRemark 航班屬性
 * @param arrivalTerminal 抵達航廈
 * @param departureTerminal 出發航廈
 * @param arrivalGate 抵達登機門
 * @param departureGate 出發登機門
 * @param codeShare 航班共用班號
 * @param isCargo 是否為貨機
 * @param acType 航空器型號
 * @param baggageClaim 行李轉盤
 * @param checkCounter 報到櫃檯
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2AviationFIDS (
    ...
    /* 航線種類 */
    val airRouteType: ServiceDTOVersion2AviationFIDS.AirRouteType? = null,
    ...
    /* 航班運行狀態,以航班的角度的狀態 */
    val flightStatus: kotlin.String? = null,
    /* 航班運行狀態(英文) */
    val flightStatusEn: kotlin.String? = null,
    /* 航班運行狀態百分比(國內線) */
    val flightStatusPC: kotlin.String? = null,
    /* 航班屬性 */
    val flightRemark: kotlin.String? = null,
    /* 抵達航廈 */
    val arrivalTerminal: kotlin.String? = null,
    /* 出發航廈 */
    val departureTerminal: kotlin.String? = null,
    /* 抵達登機門 */
    val arrivalGate: kotlin.String? = null,
    /* 出發登機門 */
    val departureGate: kotlin.String? = null,
    /* 航班共用班號 */
