...
import org.openapitools.client.models.ServiceDTOVersion2BaseNotification

/**
 * 更新通知
 * @param attempt 此更新通知嘗試呼叫次數
 * @param notifications 通知
 */
data class ServiceDTOVersion2BaseUpdateNotification (
    /* 此更新通知嘗試呼叫次數 */
    val attempt: kotlin.Int,
    /* 通知 */
    val notifications: kotlin.Array<ServiceDTOVersion2BaseNotification>
) {
