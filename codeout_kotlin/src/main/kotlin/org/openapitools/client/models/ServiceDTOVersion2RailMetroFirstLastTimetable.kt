...
/**
 * 首末班車時刻表資料
 * @param lineNo 首末班車次之路線代號
 * @param lineID 首末班車次之路線代碼
 * @param stationID 車站代號
 * @param stationName 
 * @param tripHeadSign 首末班車次之目的地方向描述
 * @param destinationStaionID 目的站車站代號
 * @param destinationStationName 
 * @param trainType 車種(1:普通車, 2:直達車)
 * @param firstTrainTime 首班車時刻
 * @param lastTrainTime 末班車時刻
 * @param serviceDays 
 ...
 */
data class ServiceDTOVersion2RailMetroFirstLastTimetable (
    /* 首末班車次之路線代號 */
    ...
    /* 首班車時刻 */
    val firstTrainTime: kotlin.String,
    /* 末班車時刻 */
    val lastTrainTime: kotlin.String,
