 ...
 * @param stopUID 站牌唯一識別代碼，規則為 {業管機關代碼} + {StopID}，其中 {業管機關代碼} 可於Authority API中的AuthorityCode欄位查詢
 ...
 */
data class ServiceDTOVersion2TaiwanTripBusBusN1EstimateTime (
    /* 去返程 */
    val direction: ServiceDTOVersion2TaiwanTripBusBusN1EstimateTime.Direction,
    ...
    /* 車輛狀態備註 */
    val stopStatus: ServiceDTOVersion2TaiwanTripBusBusN1EstimateTime.StopStatus? = null,
    /* 資料型態種類 */
    val messageType: ServiceDTOVersion2TaiwanTripBusBusN1EstimateTime.MessageType? = null,
