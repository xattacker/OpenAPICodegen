 ...
 * @param headsign 車頭描述
 * @param direction 去返程
 * @param firstBusTime 平日第一班發車時間
 * @param lastBusTime 平日返程第一班發車時間
 * @param holidayFirstBusTime 假日去程第一班發車時間
 * @param holidayLastBusTime 假日返程第一班發車時間
 */
data class ServiceDTOVersion2BusBusSubRoute (
    ...
    /* 去返程 */
    val direction: ServiceDTOVersion2BusBusSubRoute.Direction,
    /* 車頭描述 */
    val headsign: kotlin.String? = null,
    /* 平日第一班發車時間 */
    val firstBusTime: kotlin.String? = null,
    /* 平日返程第一班發車時間 */
    val lastBusTime: kotlin.String? = null,
    /* 假日去程第一班發車時間 */
    val holidayFirstBusTime: kotlin.String? = null,
    /* 假日返程第一班發車時間 */
    val holidayLastBusTime: kotlin.String? = null
) {
