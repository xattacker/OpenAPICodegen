 ...
 * @param title 消息標題
 * @param description 消息內容描述
 * @param newsUrl 消息網址連結
 * @param attachmentUrlList 消息附件網址連結
 * @param startTime 開始時間
 * @param endTime 結束時間
 * @param publishTime 消息發布日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 * @param updateTime 本平台資料更新時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2RailTHSRNews (
    /* 消息編號 */
    val newsID: java.util.UUID,
    /* 語系 */
    val language: kotlin.String,
    /* 消息類別 */
    val newsCategory: kotlin.String,
    /* 消息標題 */
    val title: kotlin.String,
    /* 消息內容描述 */
    val description: kotlin.String,
    /* 消息網址連結 */
    val newsUrl: kotlin.String,
    /* 消息附件網址連結 */
    val attachmentUrlList: kotlin.Array<kotlin.String>,
    /* 開始時間 */
