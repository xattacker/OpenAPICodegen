...
/**
 * 
 * @param fileCount 檔案連結數量
 * @param totalFileSizeBytes 檔案大小
 * @param links 檔案連結列表
 */
data class ServiceDTOVersion2BaseFileList (
    /* 檔案連結數量 */
    val fileCount: kotlin.Int? = null,
    /* 檔案大小 */
    val totalFileSizeBytes: kotlin.Long? = null,
    /* 檔案連結列表 */
    val links: kotlin.Array<kotlin.String>? = null
) {
