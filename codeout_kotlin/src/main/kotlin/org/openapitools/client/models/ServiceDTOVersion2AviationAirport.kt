...
/**
 * 機場資料
 * @param airportID 機場IATA國際代碼
 * @param airportName 
 * @param airportIATA 機場IATA國際代碼
 * @param airportICAO 機場ICAO國際代碼
 * @param airportPosition 
 * @param airportCityName 
 * @param airportAdrress 機場地址
 * @param airportPhone 機場聯繫電話
 * @param airportNationality 機場國籍
 * @param authorityID 業管機關代碼(流水號)
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2AviationAirport (
    /* 機場IATA國際代碼 */
    val airportID: kotlin.String,
    /* 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val updateTime: kotlin.String,
    val airportName: ServiceDTOVersion2BaseNameType? = null,
    /* 機場IATA國際代碼 */
    val airportIATA: kotlin.String? = null,
    /* 機場ICAO國際代碼 */
    val airportICAO: kotlin.String? = null,
    val airportPosition: ServiceDTOVersion2BasePointType? = null,
    val airportCityName: ServiceDTOVersion2BaseNameType? = null,
    /* 機場地址 */
    val airportAdrress: kotlin.String? = null,
    /* 機場聯繫電話 */
    val airportPhone: kotlin.String? = null,
    /* 機場國籍 */
    val airportNationality: kotlin.String? = null,
    /* 業管機關代碼(流水號) */
