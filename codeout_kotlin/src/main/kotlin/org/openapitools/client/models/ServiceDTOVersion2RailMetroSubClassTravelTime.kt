 ...
 * 站間運行時間資訊
 * @param sequence 站間序號
 * @param fromStationID 起站車站代號
 * @param fromStationName 
 * @param toStationID 迄站車站代號
 * @param toStationName 
 * @param runTime 站間行駛時間(秒)
 * @param stopTime 起站停靠時間(秒)
 */
data class ServiceDTOVersion2RailMetroSubClassTravelTime (
    /* 站間序號 */
    ...
    /* 站間行駛時間(秒) */
    val runTime: kotlin.Int,
    /* 起站停靠時間(秒) */
    val stopTime: kotlin.Int? = null
) {
