...
/**
 * 資訊可變標誌(CMS)資訊所在位置動態資訊
 * @param CMSID 設備代碼(營運業者代碼+設備原編號)
 * @param sourceID 營運業者代碼
 * @param status 狀態(正常為 0，通訊異常為 1，停用或施工中為 2， 設備故障為 3、目前無資料顯示為 4、目前正執行循 環顯示為 5)。
 * @param message 內容訊息
 ...
 */
data class ServiceDTOVersion2RoadTrafficCMSCMSLive (
    /* 設備代碼(營運業者代碼+設備原編號) */
    val CMSID: kotlin.String,
    /* 營運業者代碼 */
    val sourceID: kotlin.String,
    /* 狀態(正常為 0，通訊異常為 1，停用或施工中為 2， 設備故障為 3、目前無資料顯示為 4、目前正執行循 環顯示為 5)。 */
