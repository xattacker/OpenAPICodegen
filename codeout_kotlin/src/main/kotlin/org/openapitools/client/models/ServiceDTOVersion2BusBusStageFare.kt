...
import org.openapitools.client.models.ServiceDTOVersion2BusBusFare
import org.openapitools.client.models.ServiceDTOVersion2BusBusStage

import com.squareup.moshi.Json
/**
 * 此計費方式以一路線內所有站牌分區收費。(公總稱之為計費站收費, Stage=計費站)
 * @param direction 方向性描述
 * @param originStage 
 * @param destinationStage 
 * @param fares 票價內容
 */
data class ServiceDTOVersion2BusBusStageFare (
    /* 方向性描述 */
    val direction: ServiceDTOVersion2BusBusStageFare.Direction,
    val originStage: ServiceDTOVersion2BusBusStage,
    val destinationStage: ServiceDTOVersion2BusBusStage,
    /* 票價內容 */
    val fares: kotlin.Array<ServiceDTOVersion2BusBusFare>
) {
