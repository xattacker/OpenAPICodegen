...
/**
 * 觀光照片資料型別
 * @param pictureUrl1 照片連結網址1
 * @param pictureDescription1 照片說明1
 * @param pictureUrl2 照片連結網址2
 * @param pictureDescription2 照片說明2
 * @param pictureUrl3 照片連結網址3
 * @param pictureDescription3 照片說明3
 */
data class ServiceDTOVersion2ApplicationTourismPicture (
    /* 照片連結網址1 */
    val pictureUrl1: kotlin.String? = null,
    /* 照片說明1 */
    val pictureDescription1: kotlin.String? = null,
    /* 照片連結網址2 */
    val pictureUrl2: kotlin.String? = null,
    /* 照片說明2 */
    val pictureDescription2: kotlin.String? = null,
    /* 照片連結網址3 */
    val pictureUrl3: kotlin.String? = null,
    /* 照片說明3 */
    val pictureDescription3: kotlin.String? = null
) {
