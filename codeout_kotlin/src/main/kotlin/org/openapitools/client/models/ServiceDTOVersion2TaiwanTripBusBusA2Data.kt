 ...
 * @param subRouteName 
 * @param direction 去返程
 * @param stopUID 站牌唯一識別代碼，規則為 {平台代碼} + {StopID}，其中 {平台代碼} 可於Provider API中的ProviderCode欄位查詢
 * @param stopID 地區既用中之站牌代號(為原資料內碼)
 * @param stopName 
 * @param messageType 資料型態種類
 * @param dutyStatus 勤務狀態
 * @param busStatus 行車狀況
 * @param a2EventType 進站離站
 ...
 */
data class ServiceDTOVersion2TaiwanTripBusBusA2Data (
    /* 車牌號碼 */
    val plateNumb: kotlin.String,
    /* 去返程 */
    val direction: ServiceDTOVersion2TaiwanTripBusBusA2Data.Direction,
    ...
    /* 資料型態種類 */
    val messageType: ServiceDTOVersion2TaiwanTripBusBusA2Data.MessageType? = null,
    /* 勤務狀態 */
    val dutyStatus: ServiceDTOVersion2TaiwanTripBusBusA2Data.DutyStatus? = null,
    /* 行車狀況 */
    val busStatus: ServiceDTOVersion2TaiwanTripBusBusA2Data.BusStatus? = null,
    /* 進站離站 */
    val a2EventType: ServiceDTOVersion2TaiwanTripBusBusA2Data.A2EventType? = null,
    ...
    * Values: _0colon,_1colon
    */
    enum class A2EventType(val value: kotlin.String){
    
        @Json(name = "0: 離站") _0colon("0: 離站"),
    
        @Json(name = "1: 進站") _1colon("1: 進站");
