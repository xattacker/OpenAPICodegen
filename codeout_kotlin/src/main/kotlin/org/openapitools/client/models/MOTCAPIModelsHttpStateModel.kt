...
/**
 * 
 * @param forbiddenError Forbidden選項
 * @param message 錯誤訊息
 */
data class MOTCAPIModelsHttpStateModel (
    /* Forbidden選項 */
    val forbiddenError: MOTCAPIModelsHttpStateModel.ForbiddenError,
    /* 錯誤訊息 */
    ...
    */
    enum class ForbiddenError(val value: kotlin.String){
    
        @Json(name = "0: 權限不足") _0colon("0: 權限不足"),
    
        @Json(name = "1: 參數錯誤") _1colon("1: 參數錯誤");
