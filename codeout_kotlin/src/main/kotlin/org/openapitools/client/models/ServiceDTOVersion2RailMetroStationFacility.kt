...
import org.openapitools.client.models.ServiceDTOVersion2RailMetroFacilityDrinkingFountain
import org.openapitools.client.models.ServiceDTOVersion2RailMetroFacilityElevator
import org.openapitools.client.models.ServiceDTOVersion2RailMetroFacilityInformationSpot
import org.openapitools.client.models.ServiceDTOVersion2RailMetroFacilityToilet

/**
 * 捷運車站設施資料
 * @param stationID 車站代號
 * @param stationName 
 * @param elevators 無障礙電梯位置資訊
 * @param informationSpots 詢問處位置資訊
 * @param drinkingFountains 飲水機位置資訊
 * @param toilets 廁所位置資訊
 ...
 */
data class ServiceDTOVersion2RailMetroStationFacility (
    /* 車站代號 */
    val stationID: kotlin.String,
    val stationName: ServiceDTOVersion2BaseNameType,
    /* 無障礙電梯位置資訊 */
    val elevators: kotlin.Array<ServiceDTOVersion2RailMetroFacilityElevator>,
    /* 詢問處位置資訊 */
    val informationSpots: kotlin.Array<ServiceDTOVersion2RailMetroFacilityInformationSpot>,
    /* 飲水機位置資訊 */
    val drinkingFountains: kotlin.Array<ServiceDTOVersion2RailMetroFacilityDrinkingFountain>,
    /* 廁所位置資訊 */
    val toilets: kotlin.Array<ServiceDTOVersion2RailMetroFacilityToilet>,
