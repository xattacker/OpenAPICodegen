...
import org.openapitools.client.models.ServiceDTOVersion2BaseNews

/**
 * 業管機關資料型別
 * @param updateTime 更新日期時間
 * @param updateInterval 資料更新週期(秒)
 * @param newses 最新消息資訊
 */
data class ServiceDTOVersion2BaseNewsList (
    /* 更新日期時間 */
    val updateTime: kotlin.String? = null,
    /* 資料更新週期(秒) */
    val updateInterval: kotlin.Int? = null,
    /* 最新消息資訊 */
    val newses: kotlin.Array<ServiceDTOVersion2BaseNews>? = null
) {
