 ...
 * @param authorityName 
 * @param authorityPhone 業管機關連絡電話
 * @param authorityEmail 業管機關電子信箱
 * @param authorityUrl 業管機關網址鏈結
 * @param authorityCode 業管機關簡碼
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2BaseAuthority (
    /* 業管機關代碼 */
    val authorityID: kotlin.String,
    val authorityName: ServiceDTOVersion2BaseNameType,
    /* 業管機關簡碼 */
    val authorityCode: kotlin.String,
    /* 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val updateTime: kotlin.String,
    /* 業管機關連絡電話 */
    val authorityPhone: kotlin.String? = null,
    /* 業管機關電子信箱 */
    val authorityEmail: kotlin.String? = null,
    /* 業管機關網址鏈結 */
    val authorityUrl: kotlin.String? = null
) {
