...
/**
 * 座標資料型別
 * @param positionLat 位置緯度(WGS84)
 * @param positionLon 位置經度(WGS84)
 */
data class ServiceDTOVersion2BasePointType (
    /* 位置緯度(WGS84) */
    val positionLat: kotlin.Double? = null,
    /* 位置經度(WGS84) */
    val positionLon: kotlin.Double? = null
) {
