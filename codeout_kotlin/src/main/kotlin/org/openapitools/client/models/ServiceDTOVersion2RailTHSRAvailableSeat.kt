...
import org.openapitools.client.models.ServiceDTOVersion2RailTHSRStopStation
 ...
 * @param trainNo 車次號碼
 * @param direction 方向
 * @param stationID 查詢車站代碼
 * @param stationName 
 * @param departureTime 發車時間(格式: HH:mm)
 * @param endingStationID 終點車站代碼
 * @param endingStationName 
 * @param stopStations 車次停靠站點組合
 * @param srcRecTime 來源端平台接收時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 * @param updateTime 本平台資料更新時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2RailTHSRAvailableSeat (
    /* 車次號碼 */
    val trainNo: kotlin.String,
    /* 方向 */
    val direction: ServiceDTOVersion2RailTHSRAvailableSeat.Direction,
    /* 查詢車站代碼 */
    ...
    /* 車次停靠站點組合 */
    val stopStations: kotlin.Array<ServiceDTOVersion2RailTHSRStopStation>,
    /* 來源端平台接收時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val srcRecTime: kotlin.String,
