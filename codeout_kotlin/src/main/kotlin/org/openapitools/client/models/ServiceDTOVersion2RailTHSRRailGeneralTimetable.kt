...
import org.openapitools.client.models.ServiceDTOVersion2RailTHSRGeneralTimetable

/**
 * 高鐵到離站時刻資料型別
 * @param updateTime 發布時間(格式: yyyy-MM-dd)
 * @param effectiveDate 有效日期(格式: yyyy:MM:dd)
 * @param expiringDate 結束日期(格式: yyyy:MM:dd)
 * @param generalTimetable 
 */
data class ServiceDTOVersion2RailTHSRRailGeneralTimetable (
    /* 有效日期(格式: yyyy:MM:dd) */
    val effectiveDate: kotlin.String,
    /* 結束日期(格式: yyyy:MM:dd) */
    val expiringDate: kotlin.String,
    val generalTimetable: ServiceDTOVersion2RailTHSRGeneralTimetable,
    /* 發布時間(格式: yyyy-MM-dd) */
