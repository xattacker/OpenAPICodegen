...
import org.openapitools.client.models.ServiceDTOVersion2RailMetroSubClassStation
 ...
 * @param routeName 
 * @param direction 營運路線方向描述(0:去程,1:返程)
 * @param stations 營運路線車站資訊
 ...
 */
data class ServiceDTOVersion2RailMetroStationOfRoute (
    /* 營運路線所屬之路線編號 */
    ...
    /* 營運路線車站資訊 */
    val stations: kotlin.Array<ServiceDTOVersion2RailMetroSubClassStation>,
