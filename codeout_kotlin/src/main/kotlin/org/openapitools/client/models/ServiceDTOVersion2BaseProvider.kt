...
/**
 * 資料提供平台資料型別
 * @param providerID 資料提供平台代號
 * @param providerName 
 * @param providerPhone 資料提供平台連絡電話
 * @param providerEmail 資料提供平台電子信箱
 * @param providerUrl 資料提供平台網址鏈結
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 * @param providerCode 平台代碼
 */
data class ServiceDTOVersion2BaseProvider (
    /* 資料提供平台代號 */
    val providerID: kotlin.String,
    val providerName: ServiceDTOVersion2BaseNameType,
    /* 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val updateTime: kotlin.String,
    /* 平台代碼 */
    val providerCode: kotlin.String,
    /* 資料提供平台連絡電話 */
    val providerPhone: kotlin.String? = null,
    /* 資料提供平台電子信箱 */
    val providerEmail: kotlin.String? = null,
    /* 資料提供平台網址鏈結 */
