 ...
 * @param stopOfRoutes 
 */
data class ServiceDTOVersion2BusBusStopOfRouteVariation (
    /* 地區既用中之附屬路線代碼(為原資料內碼) */
    ...
    val variationType: ServiceDTOVersion2BusBusStopOfRouteVariation.VariationType,
    /* 去返程 */
    val direction: ServiceDTOVersion2BusBusStopOfRouteVariation.Direction? = null,
    /* 營運業者代碼 */
    val operatorID: kotlin.String? = null,
    val stopOfRoutes: ServiceDTOVersion2BusBusStopOfRoute? = null
) {
