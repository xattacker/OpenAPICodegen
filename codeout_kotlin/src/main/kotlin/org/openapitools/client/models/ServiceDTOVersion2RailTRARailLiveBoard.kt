 ...
 * @param endingStationID 車次終點車站代號
 * @param endingStationName 
 * @param scheduledArrivalTime 表訂到站時間(格式: HH:mm:ss)
 * @param scheduledDepartureTime 表訂離站時間(格式: HH:mm:ss)
 * @param delayTime 誤點時間(0:準點;&gt;=1誤點)
 ...
 */
data class ServiceDTOVersion2RailTRARailLiveBoard (
    /* 車站代碼 */
    ...
    /* 順逆行 */
    val direction: ServiceDTOVersion2RailTRARailLiveBoard.Direction,
    /* 列車車種代碼 */
    ...
    val endingStationName: ServiceDTOVersion2BaseNameType,
    /* 表訂到站時間(格式: HH:mm:ss) */
    val scheduledArrivalTime: kotlin.String,
    /* 表訂離站時間(格式: HH:mm:ss) */
    val scheduledDepartureTime: kotlin.String,
    /* 誤點時間(0:準點;&gt;=1誤點) */
    val delayTime: kotlin.Int,
    /* 來源端平台資料更新時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val srcUpdateTime: kotlin.String,
    /* 本平台資料更新時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val updateTime: kotlin.String,
    /* 山海線類型 */
    val tripLine: ServiceDTOVersion2RailTRARailLiveBoard.TripLine? = null
) {
