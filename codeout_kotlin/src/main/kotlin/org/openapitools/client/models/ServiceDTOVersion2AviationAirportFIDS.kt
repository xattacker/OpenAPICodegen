 ...
 * @param fiDSDeparture 出發航班顯示資料
 * @param fiDSArrival 抵達航班顯示資料
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2AviationAirportFIDS (
    /* 機場IATA國際代碼 */
    val airportID: kotlin.String,
    /* 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val updateTime: kotlin.String,
    /* 出發航班顯示資料 */
    val fiDSDeparture: kotlin.Array<ServiceDTOVersion2AviationFIDSDeparture>? = null,
    /* 抵達航班顯示資料 */
    val fiDSArrival: kotlin.Array<ServiceDTOVersion2AviationFIDSArrival>? = null
) {
