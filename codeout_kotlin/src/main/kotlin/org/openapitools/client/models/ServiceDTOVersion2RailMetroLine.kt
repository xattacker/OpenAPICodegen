 ...
 * @param lineID 路線代碼
 * @param lineName 
 * @param lineSectionName 
 * @param lineColor 路線顏色
 ...
 */
data class ServiceDTOVersion2RailMetroLine (
    /* 路線編號 */
    val lineNo: kotlin.String,
    /* 路線代碼 */
    val lineID: kotlin.String,
    val lineName: ServiceDTOVersion2BaseNameType,
    val lineSectionName: ServiceDTOVersion2BaseNameType,
    /* 路線顏色 */
    val lineColor: kotlin.String,
    /* 是否位於支線 */
