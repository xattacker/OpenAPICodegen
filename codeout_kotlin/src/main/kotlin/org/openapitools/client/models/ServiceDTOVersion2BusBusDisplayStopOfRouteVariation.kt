 ...
 * @param displayStopOfRoutes 
 */
data class ServiceDTOVersion2BusBusDisplayStopOfRouteVariation (
    /* 地區既用中之路線代碼(為原資料內碼) */
    ...
    val variationType: ServiceDTOVersion2BusBusDisplayStopOfRouteVariation.VariationType,
    /* 去返程 */
    val direction: ServiceDTOVersion2BusBusDisplayStopOfRouteVariation.Direction? = null,
    val displayStopOfRoutes: ServiceDTOVersion2BusBusDisplayStopOfRoute? = null
) {
