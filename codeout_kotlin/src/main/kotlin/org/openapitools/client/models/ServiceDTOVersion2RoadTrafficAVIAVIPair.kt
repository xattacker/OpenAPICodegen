 ...
 * @param startAVIID 配對起始點設備代碼(所屬單位代碼+設備原編號)
 * @param endAVIID 配對結束點設備代碼(所屬單位代碼+設備原編號)
 * @param roadSection 路段文字描述，填寫格式依照行經路線順序為 [行經 路段1] ([起點名稱]到[迄點名稱])-[行經路段2] ([起點 名稱]到[迄點名稱]
 ...
 */
data class ServiceDTOVersion2RoadTrafficAVIAVIPair (
    /* AVI 配對代碼(營運業者代碼+配對原編號) */
    val avIPairID: kotlin.String,
    /* 營運業者代碼 */
    val sourceID: kotlin.String,
    /* 配對起始點設備代碼(所屬單位代碼+設備原編號) */
    val startAVIID: kotlin.String? = null,
    /* 配對結束點設備代碼(所屬單位代碼+設備原編號) */
    val endAVIID: kotlin.String? = null,
    /* 路段文字描述，填寫格式依照行經路線順序為 [行經 路段1] ([起點名稱]到[迄點名稱])-[行經路段2] ([起點 名稱]到[迄點名稱] */
