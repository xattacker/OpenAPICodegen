...
import org.openapitools.client.models.ServiceDTOVersion2RailMetroNetworkSubClassLine

/**
 * 捷運路網資料
 * @param networkID 捷運路網代碼
 * @param networkName 
 * @param operatorCode 營運業者簡碼
 * @param operatorName 
 * @param networkMapURL 捷運路網圖網址URL
 * @param lines 捷運路線資訊
 * @param updateTime 本平台資料更新時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2RailMetroNetwork (
    /* 捷運路網代碼 */
    val networkID: kotlin.String,
    val networkName: ServiceDTOVersion2BaseNameType,
    /* 營運業者簡碼 */
    ...
    /* 捷運路線資訊 */
    val lines: kotlin.Array<ServiceDTOVersion2RailMetroNetworkSubClassLine>,
