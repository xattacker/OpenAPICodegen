...
/**
 * 自動車輛辨識(AVI)資訊靜態資訊
 * @param AVIID 設備代碼(營運業者代碼+設備原編號)
 * @param sourceID 營運業者代碼
 * @param roadsection 路段文字描
 ...
 * @param px 辨識設備架設位置 X 坐標(坐標系統為 WGS84)
 * @param py 辨識設備架設位置 Y 坐標(坐標系統為 WGS84)
 ...
 */
data class ServiceDTOVersion2RoadTrafficAVIAVIInfo (
    /* 設備代碼(營運業者代碼+設備原編號) */
    val AVIID: kotlin.String,
    /* 營運業者代碼 */
    ...
    /* 辨識設備架設位置 X 坐標(坐標系統為 WGS84) */
    val px: kotlin.String? = null,
    /* 辨識設備架設位置 Y 坐標(坐標系統為 WGS84) */
