 ...
 */
data class ServiceDTOVersion2RailTRAServiceDay (
    /* 星期一是否營運 */
    val monday: ServiceDTOVersion2RailTRAServiceDay.Monday,
    /* 星期二是否營運 */
    val tuesday: ServiceDTOVersion2RailTRAServiceDay.Tuesday,
    /* 星期三是否營運 */
    val wednesday: ServiceDTOVersion2RailTRAServiceDay.Wednesday,
    /* 星期四是否營運 */
    val thursday: ServiceDTOVersion2RailTRAServiceDay.Thursday,
    /* 星期五是否營運 */
    val friday: ServiceDTOVersion2RailTRAServiceDay.Friday,
    /* 星期六是否營運 */
    val saturday: ServiceDTOVersion2RailTRAServiceDay.Saturday,
    /* 星期日是否營運 */
    val sunday: ServiceDTOVersion2RailTRAServiceDay.Sunday
) {
