 ...
 * @param schedules 
 */
data class ServiceDTOVersion2BusBusScheduleVariation (
    /* 地區既用中之附屬路線代碼(為原資料內碼) */
    ...
    val variationType: ServiceDTOVersion2BusBusScheduleVariation.VariationType,
    /* 去返程 */
    val direction: ServiceDTOVersion2BusBusScheduleVariation.Direction? = null,
    /* 營運業者代碼 */
    val operatorID: kotlin.String? = null,
    val schedules: ServiceDTOVersion2BusBusSchedule? = null
) {
