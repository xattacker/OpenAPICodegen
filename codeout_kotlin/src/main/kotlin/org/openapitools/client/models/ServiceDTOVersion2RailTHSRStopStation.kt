 ...
 * @param stationName 
 * @param standardSeatStatus 標準席剩餘座位狀態 = ['Available: 尚有座位' or 'Limited: 座位有限' or 'Full: 已無座位']
 * @param businessSeatStatus 商務席剩餘座位狀態 =  ['Available: 尚有座位' or 'Limited: 座位有限' or 'Full: 已無座位']
 */
data class ServiceDTOVersion2RailTHSRStopStation (
    /* 車站代碼 */
    ...
    val standardSeatStatus: kotlin.String,
    /* 商務席剩餘座位狀態 =  ['Available: 尚有座位' or 'Limited: 座位有限' or 'Full: 已無座位'] */
    val businessSeatStatus: kotlin.String
) {
