 ...
 * @param lineNo 路線編號
 * @param lineID 路線代碼
 * @param lineNameZh 路線中文名稱
 * @param lineNameEn 路線英文名稱
 * @param lineSectionNameZh 路線區間中文名稱
 * @param lineSectionNameEn 路線區間英文名稱
 * @param isBranch 是否位於支線
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2RailTRALine (
    /* 路線編號 */
    val lineNo: kotlin.String,
    /* 路線代碼 */
    val lineID: kotlin.String,
    /* 路線中文名稱 */
    val lineNameZh: kotlin.String,
    /* 路線英文名稱 */
    val lineNameEn: kotlin.String,
    /* 路線區間中文名稱 */
    val lineSectionNameZh: kotlin.String,
    /* 路線區間英文名稱 */
    val lineSectionNameEn: kotlin.String,
    /* 是否位於支線 */
    val isBranch: kotlin.Boolean,
