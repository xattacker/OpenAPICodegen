 ...
 * @param stops 
 */
data class ServiceDTOVersion2BusBusStopVariation (
    /* 地區既用中之站牌代碼(為原資料內碼) */
    ...
    val variationType: ServiceDTOVersion2BusBusStopVariation.VariationType,
    val stops: ServiceDTOVersion2BusBusStop? = null
) {
