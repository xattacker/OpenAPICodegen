 ...
 * @param routeName 
 * @param direction 去返程，若無值則表示來源尚無區分去返程
 * @param geometry well-known text，為路線軌跡資料
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 * @param versionID 資料版本編號
 */
data class ServiceDTOVersion2BusBusShape (
    ...
    /* 去返程，若無值則表示來源尚無區分去返程 */
    val direction: ServiceDTOVersion2BusBusShape.Direction,
    /* well-known text，為路線軌跡資料 */
    val geometry: kotlin.String,
