 ...
 * @param operatorName 
 * @param operatorPhone 營運業者連絡電話
 * @param operatorEmail 營運業者電子信箱
 * @param operatorUrl 營運業者網址鏈結
 * @param reservationUrl 訂票網址鏈結
 * @param reservationPhone 訂票連絡電話
 * @param operatorCode 營運業者簡碼
 * @param authorityCode 營運業者業管機關簡碼(對於於公路客運/國道客運而言為THB)
 * @param subAuthorityCode 營運業者所屬業管子機關簡碼(對於公路客運/國道客運路線而言為區監理所如THB-VO10-1..等)
 * @param operatorNo 營運業者編號[交通部票證資料系統定義]
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2BaseOperator (
    /* 資料提供平台代碼 */
    val providerID: kotlin.String,
    /* 營運業者代碼 */
    val operatorID: kotlin.String,
    val operatorName: ServiceDTOVersion2BaseNameType,
    /* 營運業者簡碼 */
    val operatorCode: kotlin.String,
    /* 營運業者業管機關簡碼(對於於公路客運/國道客運而言為THB) */
    val authorityCode: kotlin.String,
    /* 營運業者編號[交通部票證資料系統定義] */
    val operatorNo: kotlin.String,
    /* 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val updateTime: kotlin.String,
    /* 營運業者連絡電話 */
    val operatorPhone: kotlin.String? = null,
    /* 營運業者電子信箱 */
    val operatorEmail: kotlin.String? = null,
    /* 營運業者網址鏈結 */
    val operatorUrl: kotlin.String? = null,
    /* 訂票網址鏈結 */
    val reservationUrl: kotlin.String? = null,
    /* 訂票連絡電話 */
    val reservationPhone: kotlin.String? = null,
    /* 營運業者所屬業管子機關簡碼(對於公路客運/國道客運路線而言為區監理所如THB-VO10-1..等) */
    val subAuthorityCode: kotlin.String? = null
) {
