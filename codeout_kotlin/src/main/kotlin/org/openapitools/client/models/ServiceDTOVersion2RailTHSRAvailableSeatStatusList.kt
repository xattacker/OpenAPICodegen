...
import org.openapitools.client.models.ServiceDTOVersion2RailTHSRAvailableSeat

/**
 * 高鐵對號座位狀態看板資料
 * @param updateTime 更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 * @param availableSeats 對號座位狀態資訊(依高鐵規定若營運狀態有異常狀況時，剩餘座位資訊將停留在最後正常運行時間之狀態不做更新，實際資料請參考高鐵各車站對號座剩餘座位資訊看板)
 */
data class ServiceDTOVersion2RailTHSRAvailableSeatStatusList (
    ...
    val availableSeats: kotlin.Array<ServiceDTOVersion2RailTHSRAvailableSeat>
) {
