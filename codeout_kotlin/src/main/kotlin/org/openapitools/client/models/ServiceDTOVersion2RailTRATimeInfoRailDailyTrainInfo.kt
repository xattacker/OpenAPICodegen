 ...
 * @param note 
 */
data class ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo (
    /* 車次代碼 */
    val trainNo: kotlin.String,
    /* 順逆行 */
    val direction: ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo.Direction,
    /* 列車車種代碼 */
    ...
    /* 是否設身障旅客專用座位車 */
    val wheelchairFlag: ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo.WheelchairFlag,
    /* 是否提供行李服務 */
    val packageServiceFlag: ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo.PackageServiceFlag,
    /* 是否提供餐車服務 */
    val diningFlag: ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo.DiningFlag,
    /* 是否人車同行班次(置於攜車袋之自行車各級列車均可乘車) */
    val bikeFlag: ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo.BikeFlag,
    /* 是否設有哺(集)乳室車廂 */
    val breastFeedingFlag: ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo.BreastFeedingFlag,
    /* 是否為每日行駛 */
    val dailyFlag: ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo.DailyFlag,
    /* 是否為加班車 */
    val serviceAddedFlag: kotlin.Boolean,
    /* 列車起點車站代號 */
    ...
    /* 山海線類型 */
    val tripLine: ServiceDTOVersion2RailTRATimeInfoRailDailyTrainInfo.TripLine? = null,
    /* 跨夜車站代碼 */
