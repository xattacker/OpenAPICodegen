 ...
 * @param publishTime 消息公告日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 * @param startTime 開始時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 * @param endTime 結束時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 * @param updateTime 本平台資料更新時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2BusBusNews (
    /* 最新消息原單位發布代碼 */
    val newsID: kotlin.String,
    /* 語系 */
    ...
    /* 消息類別 */
    val newsCategory: kotlin.String? = null,
    /* 報導網站連結 */
