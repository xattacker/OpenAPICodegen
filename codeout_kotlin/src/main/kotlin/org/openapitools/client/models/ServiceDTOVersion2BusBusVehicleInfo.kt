 ...
 */
data class ServiceDTOVersion2BusBusVehicleInfo (
    /* 車牌號碼 */
    val plateNumb: kotlin.String,
    /* 車輛種類 */
    val vehicleType: ServiceDTOVersion2BusBusVehicleInfo.VehicleType,
    ...
    /**
    * 車輛種類
    * Values: _0colon,_1colon,_2colon,_3colon
    */
    enum class VehicleType(val value: kotlin.String){
    
        @Json(name = "0: 一般") _0colon("0: 一般"),
    
        @Json(name = "1: 低地板") _1colon("1: 低地板"),
    
        @Json(name = "2: 復康巴士") _2colon("2: 復康巴士"),
    
        @Json(name = "3: 小型巴士") _3colon("3: 小型巴士");
