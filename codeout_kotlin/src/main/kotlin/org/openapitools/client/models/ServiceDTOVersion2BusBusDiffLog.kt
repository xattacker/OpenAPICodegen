...
import org.openapitools.client.models.ServiceDTOVersion2BusVariation
 ...
 * @param variations 
 */
data class ServiceDTOVersion2BusBusDiffLog (
    /* 資料版本編號(舊) */
    val oldVersionID: kotlin.Int,
    /* 資料版本編號(新) */
    val newVersionID: kotlin.Int,
    val variations: ServiceDTOVersion2BusVariation
) {
