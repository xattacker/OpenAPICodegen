 ...
 * @param lineID 路線代碼
 * @param lineName 
 * @param stationID 所在車站代號
 * @param stationName 
 * @param tripHeadSign 下班車次方向描述
 * @param destinationStaionID 目的地車站代號
 * @param destinationStationName 
 * @param estimateTime 下班車次抵達時間預估(秒)
