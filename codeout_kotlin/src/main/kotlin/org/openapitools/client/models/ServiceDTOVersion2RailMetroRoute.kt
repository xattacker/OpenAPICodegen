 ...
 * @param operatorCode 營運業者代碼
 * @param routeName 
 * @param railRouteType 軌道路線類別(33:都市捷運;34:機場捷運)
 * @param lineNo 營運路線所屬之路線編號
 * @param lineID 營運路線所屬之路線代碼
 * @param startStationID 營運路線起站代號
 * @param startStationName 
 * @param endStationID 營運路線迄站代號
 * @param endStationName 
 * @param travelTime 營運路線運行時間
 * @param routeLength 營運路線長度距離
 ...
 */
data class ServiceDTOVersion2RailMetroRoute (
    /* 營運路線代碼 */
    ...
    val railRouteType: kotlin.Int,
    /* 營運路線所屬之路線編號 */
    val lineNo: kotlin.String,
    /* 營運路線所屬之路線代碼 */
    val lineID: kotlin.String,
    /* 營運路線起站代號 */
    val startStationID: kotlin.String,
    val startStationName: ServiceDTOVersion2BaseNameType,
    /* 營運路線迄站代號 */
    val endStationID: kotlin.String,
    val endStationName: ServiceDTOVersion2BaseNameType,
    /* 營運路線運行時間 */
    val travelTime: kotlin.Int,
    /* 營運路線長度距離 */
    val routeLength: kotlin.Float,
