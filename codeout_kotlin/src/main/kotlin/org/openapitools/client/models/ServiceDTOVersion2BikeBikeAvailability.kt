 ...
 * @param servieAvailable 服務狀態
 * @param availableRentBikes 可租借車數
 * @param availableReturnBikes 可歸還車數
 ...
 */
data class ServiceDTOVersion2BikeBikeAvailability (
    ...
    /* 服務狀態 */
    val servieAvailable: ServiceDTOVersion2BikeBikeAvailability.ServieAvailable? = null,
    /* 可租借車數 */
    val availableRentBikes: kotlin.Int? = null,
    /* 可歸還車數 */
    val availableReturnBikes: kotlin.Int? = null
) {
    ...
    */
    enum class ServieAvailable(val value: kotlin.String){
    
        @Json(name = "0: 停止營運") _0colon("0: 停止營運"),
    
        @Json(name = "1: 正常營運") _1colon("1: 正常營運");
