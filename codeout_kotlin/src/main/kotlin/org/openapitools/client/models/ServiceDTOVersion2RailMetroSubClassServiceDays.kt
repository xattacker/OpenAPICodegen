...
/**
 * 服務日型態
 * @param serviceTag 營運日標籤
 * @param monday 星期一營運與否
 * @param tuesday 星期二營運與否
 * @param wednesday 星期三營運與否
 * @param thursday 星期四營運與否
 * @param friday 星期五營運與否
 * @param saturday 星期六營運與否
 * @param sunday 星期日營運與否
 * @param nationalHolidays 國定假日營運與否
 */
data class ServiceDTOVersion2RailMetroSubClassServiceDays (
    /* 星期一營運與否 */
    ...
    /* 國定假日營運與否 */
    val nationalHolidays: kotlin.Boolean,
    /* 營運日標籤 */
    val serviceTag: kotlin.String? = null
) {
