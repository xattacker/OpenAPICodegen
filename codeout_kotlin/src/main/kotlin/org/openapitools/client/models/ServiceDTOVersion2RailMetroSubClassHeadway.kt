...
/**
 * 班距頻率資訊
 * @param peakFlag 尖峰/離峰狀態(0:離峰, 1:尖峰)
 * @param startTime 開始時間
 * @param endTime 結束時間
 * @param minHeadwayMins 最小班距時間(分)
 * @param maxHeadwayMins 最大班距時間(分)
 */
data class ServiceDTOVersion2RailMetroSubClassHeadway (
    /* 尖峰/離峰狀態(0:離峰, 1:尖峰) */
    val peakFlag: kotlin.String,
    /* 開始時間 */
