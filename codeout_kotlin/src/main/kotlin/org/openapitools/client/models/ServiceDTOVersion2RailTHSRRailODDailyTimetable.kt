...
import org.openapitools.client.models.ServiceDTOVersion2RailTHSRTimeInfoRailDailyTrainInfo

/**
 * 高鐵起訖站間到離站時刻資料型別
 * @param trainDate 行駛日期(格式: yyyy:MM:dd)
 * @param dailyTrainInfo 
 * @param originStopTime 
 * @param destinationStopTime 
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2RailTHSRRailODDailyTimetable (
    /* 行駛日期(格式: yyyy:MM:dd) */
    val trainDate: kotlin.String,
    val dailyTrainInfo: ServiceDTOVersion2RailTHSRTimeInfoRailDailyTrainInfo,
    val originStopTime: ServiceDTOVersion2RailTHSRRailStopTime,
    val destinationStopTime: ServiceDTOVersion2RailTHSRRailStopTime,
