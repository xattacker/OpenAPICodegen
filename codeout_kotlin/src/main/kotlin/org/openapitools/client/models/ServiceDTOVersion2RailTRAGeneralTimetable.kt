...
import org.openapitools.client.models.ServiceDTOVersion2RailTRARailStopTime
import org.openapitools.client.models.ServiceDTOVersion2RailTRAServiceDay
import org.openapitools.client.models.ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo

/**
 * 台鐵定期時刻表資料型別
 * @param generalTrainInfo 
 * @param stopTimes 停靠時間資料
 * @param serviceDay 
 * @param srcUpdateTime 來源端平台資料更新時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2RailTRAGeneralTimetable (
    val generalTrainInfo: ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo,
    /* 停靠時間資料 */
    val stopTimes: kotlin.Array<ServiceDTOVersion2RailTRARailStopTime>,
    val serviceDay: ServiceDTOVersion2RailTRAServiceDay,
