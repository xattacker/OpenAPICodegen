 ...
 * 
 * @param carID 車種代碼
 * @param volume 依車道/車種逐一詳列 1分鐘 或 5分鐘流量偵測值
 */
data class ServiceDTOVersion2RoadTrafficVDCars (
    /* 車種代碼 */
    val carID: kotlin.String? = null,
    /* 依車道/車種逐一詳列 1分鐘 或 5分鐘流量偵測值 */
    val volume: kotlin.Float? = null
) {
