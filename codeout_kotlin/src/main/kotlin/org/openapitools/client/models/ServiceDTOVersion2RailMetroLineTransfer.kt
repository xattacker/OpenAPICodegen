...
/**
 * 捷運路線站間轉乘基本資料
 * @param fromLineNo 路線間轉乘(起)之路線編號
 * @param fromLineID 路線間轉乘(起)之路線代碼
 * @param fromLineName 
 * @param fromStationID 路線間轉乘(起)之車站代碼
 * @param fromStationName 
 * @param toLineNo 路線間轉乘(迄)之路線編號
 * @param toLineID 路線間轉乘(迄)之路線代碼
 * @param toLineName 
 * @param toStationID 路線間轉乘(迄)之車站代碼
 * @param toStationName 
 * @param transferTime 轉乘耗時參考時間(分)
 * @param transferDescription 轉乘方式文字描述
 ...
 */
data class ServiceDTOVersion2RailMetroLineTransfer (
    /* 路線間轉乘(起)之路線編號 */
    val fromLineNo: kotlin.String,
    /* 路線間轉乘(起)之路線代碼 */
    val fromLineID: kotlin.String,
    val fromLineName: ServiceDTOVersion2BaseNameType,
    /* 路線間轉乘(起)之車站代碼 */
    val fromStationID: kotlin.String,
    val fromStationName: ServiceDTOVersion2BaseNameType,
    /* 路線間轉乘(迄)之路線編號 */
    val toLineNo: kotlin.String,
    /* 路線間轉乘(迄)之路線代碼 */
    val toLineID: kotlin.String,
    val toLineName: ServiceDTOVersion2BaseNameType,
    /* 路線間轉乘(迄)之車站代碼 */
    val toStationID: kotlin.String,
    val toStationName: ServiceDTOVersion2BaseNameType,
    /* 轉乘耗時參考時間(分) */
    val transferTime: kotlin.Int,
    /* 轉乘方式文字描述 */
    val transferDescription: kotlin.String,
