 ...
 * @param airlineName 
 * @param airlineNameAlias 
 * @param airlineIATA 航空公司IATA國際代碼
 * @param airlineICAO 航空公司ICAO國際代碼
 * @param airlineEmail 航空公司電子信箱
 * @param airlineAddress 航空公司地址
 * @param airlinePhone 航空公司聯繫電話
 * @param airlineNationality 航空公司國籍
 * @param updateTime 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz)
 */
data class ServiceDTOVersion2AviationAirline (
    /* 航空公司IATA國際代碼 */
    val airlineID: kotlin.String,
    /* 資料更新日期時間(ISO8601格式:yyyy-MM-ddTHH:mm:sszzz) */
    val updateTime: kotlin.String,
    val airlineName: ServiceDTOVersion2BaseNameType? = null,
    val airlineNameAlias: ServiceDTOVersion2BaseNameType? = null,
    /* 航空公司IATA國際代碼 */
    val airlineIATA: kotlin.String? = null,
    /* 航空公司ICAO國際代碼 */
    val airlineICAO: kotlin.String? = null,
    /* 航空公司電子信箱 */
    val airlineEmail: kotlin.String? = null,
    /* 航空公司地址 */
    val airlineAddress: kotlin.String? = null,
    /* 航空公司聯繫電話 */
    val airlinePhone: kotlin.String? = null,
    /* 航空公司國籍 */
    val airlineNationality: kotlin.String? = null
) {
